...
<https://github.com/sepehrmn/NCP> (tag `v0.2.0`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepehrmn/NCP, tag v0.2.0)
...
published NCP repo <https://github.com/sepehrmn/NCP> (tag `v0.2.0`), so no sibling
