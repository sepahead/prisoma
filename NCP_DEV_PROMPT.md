...
<https://github.com/sepahead/NCP> (tag `v0.2.7`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepahead/NCP, tag v0.2.7)
...
published NCP repo <https://github.com/sepahead/NCP> (tag `v0.2.7`), so no sibling
