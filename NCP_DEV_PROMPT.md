...
<https://github.com/sepahead/NCP> (tag `v0.4.0`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepahead/NCP, tag v0.4.0)
...
published NCP repo <https://github.com/sepahead/NCP> (tag `v0.4.0`), so no sibling
