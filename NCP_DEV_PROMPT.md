...
<https://github.com/sepehrmn/NCP> (tag `v0.2.4`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepehrmn/NCP, tag v0.2.4)
...
published NCP repo <https://github.com/sepehrmn/NCP> (tag `v0.2.4`), so no sibling
