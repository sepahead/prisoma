...
<https://github.com/sepahead/NCP> (tag `v0.2.8`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepahead/NCP, tag v0.2.8)
...
published NCP repo <https://github.com/sepahead/NCP> (tag `v0.2.8`), so no sibling
