...
<https://github.com/sepahead/NCP> (tag `v0.3.0`). Build/test it explicitly:

```bash
# build + test (pulls NCP from https://github.com/sepahead/NCP, tag v0.3.0)
...
published NCP repo <https://github.com/sepahead/NCP> (tag `v0.3.0`), so no sibling
