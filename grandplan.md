...
post-review pin and public-repository changes as of 2026-07-26. Those changes may raise an external
...
|---|---|---:|---|---|
| `pid-rs` | Direct git submodule deliberately pinned to the 0.9.0 post-tag review source at `796c11e70f009634b853dc4ada6f565563d82f51`, seven commits after the immutable `v0.9.0` review tag at `a9a275157237999c8da6ab813130d74f6113dec9`; Prisoma crates path-depend on its estimator/run-log crates. Public main was observed at `e50c12e0af2cc79682a87e5ac65c4fe1d8cf2b94` | E2; root and consumer conformance checks support E3 for the tested local paths | canonical estimator implementation, run-log schema, low-dimensional analytic/external fixtures, discrete references, fail-closed support contracts and reports | upstream main adds unadopted contracts, formal results, and exact-certifier work, but says Prisoma integration is not claimed. Retain the reviewed pin until consumer-owned compatibility and scientific-value checks pass. The current fixtures do not establish VLA application validity [R72–R73] |
| `NCP` | Optional `ncp-observer`, excluded from default workspace, pinned to immutable NCP `v0.8.0` at `2f5bd586` (wire 0.8). Public main at `10492c81ac671ef1909962a9f1fede33781b9933` is an unreleased, release-blocked `1.0.0-rc.1` wire-1.0 candidate. Full-key visible-receipt integrity and receipt-last bundles are local-only. A bounded 18-case observatory replays a complete hand-authored trace twice through the shared route/raw decoder and separates native response from its manifest oracle | E2 dependency edge; E3-style local evidence for the exact fixture/consumer only | optional source of versioned observations from neural/robotic systems; deterministic decoder/join/finalization/replay fault checks | retain the wire-0.8 read-only pin; do not infer wire-1.0 compatibility. Require a conforming live producer, migration corpus, own-stream/timing/QoS/reconnect/authentication evidence, interventions/outcomes, and an E4 report. Whole-tick omission remains a native blind spot; no PID population support is inferred [R72, R74] |
...
| `crebain` | Public revision `cb0f1a312259af6af7d7f3a5d05c522ed36655d1` adds a supervised read-only Engram view to the 0.9.0 research prerelease. Embedded mode disables native, external telemetry, artifact exchange, NCP, and plant paths. NCP action/control commands stay unregistered, and no direct Prisoma reference exists | E0 between Crebain and Prisoma; the read-only Engram view does not create a direct edge | candidate non-manipulation embodiment, multimodal tracking/fusion testbed, timing/fault-injection or advisory-evidence producer | host messages do not attest a process or build. A local `put` does not prove receiver receipt. No live NCP control loop or direct Prisoma adapter exists [R76] |
...
| `Paper2Brain` (Engram Neural Labs host) | Public revision `18fb57c6164d6291cac84ae15c65ab6119715157` imports the byte-locked Prisoma descriptor at module load and tests the `prisoma-runlog-v1` structural preview. Its development NCP service uses candidate wire 1.0 | E2 declared immutable consumer-manifest relationship; not E3 because no producer-consumer golden fixture exists | host-rendered review of bounded Prisoma run-log artifacts and a candidate future neural-state producer | the structural preview is not Prisoma validation. The descriptor starts no process and grants no authority. Prisoma remains on wire 0.8. No live producer, wire translator, artifact importer, NCP bridge, golden fixture, or E4 report exists [R74, R78] |
...
Public main at `e50c12e0af2cc79682a87e5ac65c4fe1d8cf2b94` adds unadopted method catalogs,
software identity, outcome contracts, formal results, and exact-certifier work. These additions
do not open the high-dimensional or application gates. A later pin requires consumer-owned
compatibility, exact-reference, and regression evidence against the frozen Prisoma contract.
...
Prisoma manifest and tested structural preview create an E2 consumer edge, not E3 conformance.
No live producer, NCP bridge, wire translator, or authority path exists. WorldWarp and GauSS-MI
...
**Current implementation boundary (reviewed through 2026-07-26).** The repository ships the historical
...
- **[R73]** `sepahead/pid-rs`. *Shared-exclusions partial information decomposition and mutual-information estimators in Rust*. Reviewed Prisoma pin `8a5a9dda601556443f956a2fba164cccc913ed2e`, contract-hardening revision `70b45f7b75fac06777ea215a73df01209490311a`, immutable `v0.9.0` review-tag commit `a9a275157237999c8da6ab813130d74f6113dec9`, current Prisoma pin `796c11e70f009634b853dc4ada6f565563d82f51`, and unadopted public main `e50c12e0af2cc79682a87e5ac65c4fe1d8cf2b94`, rechecked 24 July 2026. The current pin includes the public-`csxpid` fixture, agreement within `1e-12` nats after recorded conversion, fail-closed population-support contracts, default-off research features, and bounded report-first APIs. Public main adds method catalogs, software identity, outcome/run-log contracts, formal results, support-change work, and an exact-count SxPID2 certifier, but its ecosystem file states that Prisoma integration is not claimed. The 0.9 review source makes no 1.x compatibility, registry, or published-wheel promise. Neither revision establishes high-dimensional VLA application validity or independent corroboration. https://github.com/sepahead/pid-rs/tree/796c11e70f009634b853dc4ada6f565563d82f51 ; https://github.com/sepahead/pid-rs/tree/e50c12e0af2cc79682a87e5ac65c4fe1d8cf2b94
- **[R74]** `sepahead/NCP`, immutable release `v0.8.0` at peeled commit `2f5bd586d4bb20c90362bb6f5698b7f64057ba4e`, wire 0.8. *Neuro-Cybernetic Protocol*. Rechecked 24 July 2026. Prisoma deliberately retains this immutable consumer pin. Public main `10492c81ac671ef1909962a9f1fede33781b9933` is an unreleased, release-blocked `1.0.0-rc.1` wire-1.0 candidate. Its consumer inventory identifies Prisoma as wire 0.8 and not wire-1.0 certified. Prisoma remains a read-only observer with documented transport and security limits. https://github.com/sepahead/NCP/tree/v0.8.0 ; https://github.com/sepahead/NCP/tree/10492c81ac671ef1909962a9f1fede33781b9933
...
- **[R76]** `sepahead/crebain`. *Multi-UAV simulation and airspace-awareness research testbed*, public revision `cb0f1a312259af6af7d7f3a5d05c522ed36655d1`, inspected 26 July 2026. It adds a supervised read-only Engram view to the 0.9.0 research prerelease. Embedded mode disables native, external telemetry, artifact exchange, NCP, and plant paths. Host messages do not attest a process or build. NCP action/control commands remain unregistered. No live NCP control loop or direct Prisoma adapter exists. https://github.com/sepahead/crebain/tree/cb0f1a312259af6af7d7f3a5d05c522ed36655d1
...
- **[R78]** `sepahead/engram` and `sepahead/Paper2Brain`, inspected 26 July 2026. The named Engram repository remains a README-only placeholder at `a4ce6ab9897dd3f1265b4cacc53f0afc349087cd`. The executable Engram Neural Labs host lives in Paper2Brain at `18fb57c6164d6291cac84ae15c65ab6119715157`. Paper2Brain imports the byte-locked Prisoma descriptor and tests the `prisoma-runlog-v1` structural preview, which creates an E2 consumer-manifest relationship. The preview is not Prisoma validation. Prisoma remains on wire 0.8 while the host uses candidate wire 1.0. No live Paper2Brain-to-Prisoma producer, wire translator, NCP bridge, producer-consumer fixture, authority path, or E4 report exists. https://github.com/sepahead/engram/tree/a4ce6ab9897dd3f1265b4cacc53f0afc349087cd ; https://github.com/sepahead/Paper2Brain/tree/18fb57c6164d6291cac84ae15c65ab6119715157
