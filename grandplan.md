...
post-review pin and public-repository changes as of 2026-07-24. Those changes may raise an external
...
| `crebain` | Public revision `0a58a5b8dd799884ddb06f1308b1748216fab322` is a 0.9.0 research prerelease with a bounded Galadriel sender and historical fixture. Its inactive plant-contract surfaces and profile-neutral ENU/NED + FLU/FRD velocity-axis corpus remain. NCP action/control commands stay unregistered, and no direct Prisoma reference or managed product route exists | E0 between projects; upstream component and historical-fixture evidence do not create a Prisoma edge | candidate non-manipulation embodiment, multimodal tracking/fusion testbed, timing/fault-injection or advisory-evidence producer | a local `put` does not prove reciprocal Galadriel receipt, correlation, or deployed TLS/ACL. The frame corpus is not called by admission and does not prove frame instance/origin/datum/body point. No live Crebain↔Engram loop exists [R76] |
...
**Current implementation boundary (reviewed through 2026-07-24).** The repository ships the historical
...
- **[R76]** `sepahead/crebain`. *Multi-UAV simulation and airspace-awareness research testbed*, public revision `0a58a5b8dd799884ddb06f1308b1748216fab322`, inspected 24 July 2026. It is a public 0.9.0 research prerelease with a bounded Galadriel sender and historical fixture. Local publication does not prove reciprocal Galadriel receipt, correlation, or deployed TLS/ACL. Its frame corpus is not called by admission and proves no frame instance, origin, datum, or body point. NCP action/control commands remain unregistered. No live Crebain↔Engram loop or direct Prisoma adapter exists. https://github.com/sepahead/crebain/tree/0a58a5b8dd799884ddb06f1308b1748216fab322
