...
**Version:** 10.5 (Consistency + robustness slice: pid-rs submodule → v0.3.0, NCP observer pin → v0.5.2, ncp-observer label-leak + bounded-buffer + robustness fixes, dual-license notice, honest provenance docs — research status unchanged from v10.4)
**Date:** 2026-07-01
**Status:** Research Specification + Implementation Blueprint (v10.5 updated)
