...
| `haldir` | Reviewed public revision `2a55f3d` contains a tested P0 experimental gate, threat model, claim ledger, and modeled NCP-0.8 adapter; no direct Prisoma dependency or live transport edge exists | E0 between projects; Haldir’s internal P0 tests are not Prisoma integration evidence | optional security/attestation comparator for authority, receipts, replay, and fail-closed decision semantics | no Prisoma security claim until a consumer-owned adapter, live exclusive route, immutable release, threat-model mapping, and E4 conformance report exist [R86] |
...
- **[R86]** `sepahead/haldir`, reviewed public revision `2a55f3dc8f78fa3b5c8d11dd02a2de5f4ef8d721`, inspected 12 July 2026. That revision contains a tested P0 experimental gate, threat model, claim ledger, and modeled NCP-0.8 adapter; it explicitly leaves live exclusive transport and production claims unproven, and no direct Prisoma edge exists. https://github.com/sepahead/haldir/tree/2a55f3dc8f78fa3b5c8d11dd02a2de5f4ef8d721
