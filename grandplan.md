...
post-review pin and public-repository changes as of 2026-07-12. Those changes may raise an external
...
| `engram` | Public main at `a6f2c5f` now contains an implemented neurocontrol/NCP reference stack and tests, but no direct Prisoma dependency or adapter; its committed NCP mirror remains `v0.7.0`, incompatible with Prisoma’s wire-0.8 observer | E0 between projects; internal Engram implementation evidence does not promote the edge | candidate neural-state producer and memory/dynamics intervention source after a wire-compatible, read-only adapter exists | cannot be a thesis dependency; require NCP 0.8 migration, immutable producer revision, variable semantics, security/noninterference evidence, fixture, and E4 conformance [R74, R78] |
...
| `haldir` | Public main at `2a55f3d` now contains a tested P0 experimental gate, threat model, claim ledger, and modeled NCP-0.8 adapter; no direct Prisoma dependency or live transport edge exists | E0 between projects; Haldir’s internal P0 tests are not Prisoma integration evidence | optional security/attestation comparator for authority, receipts, replay, and fail-closed decision semantics | no Prisoma security claim until a consumer-owned adapter, live exclusive route, immutable release, threat-model mapping, and E4 conformance report exist [R86] |
...
- **[R78]** `sepahead/engram`. *Engram Neural Labs*, current public main `a6f2c5f973783373db9d90769d981b1d549a5b6b`, inspected 12 July 2026. The repository now contains an implemented neurocontrol/NCP reference stack and tests; its committed NCP mirror remains `v0.7.0`, and no direct Prisoma adapter or E4 conformance report was found. https://github.com/sepahead/engram/tree/a6f2c5f973783373db9d90769d981b1d549a5b6b
...
- **[R86]** `sepahead/haldir`, current public main `2a55f3dc8f78fa3b5c8d11dd02a2de5f4ef8d721`, inspected 12 July 2026. The repository contains a tested P0 experimental gate, threat model, claim ledger, and modeled NCP-0.8 adapter; it explicitly leaves live exclusive transport and production claims unproven, and no direct Prisoma edge exists. https://github.com/sepahead/haldir/tree/2a55f3dc8f78fa3b5c8d11dd02a2de5f4ef8d721
