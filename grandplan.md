...
**Version:** 10.4 (Science-honesty + tooling slice: enforced axis-provenance gate, safe_adapter provenance surfacing, NCP v0.5.0 observer re-pin, prisoma rename — research status unchanged from v10.3)
**Date:** 2026-06-22
**Status:** Research Specification + Implementation Blueprint (v10.4 updated)
