...
- `m0_preregistration_successor_draft_v2.json` is a revised **typed successor draft**, not a
  preregistration or freeze candidate. The 2026-08-12 first-principles correction reopened its
  scientific and statistical review. It exact-binds the historical v1 bytes and adds null,
  ...
  multiplicity, replication target, support acceptance, and warning-code dispositions;
...
The v2 file remains an all-null, revised, unreviewed draft contract.
