...
- **sae_analysis:** Makkeh A (2025). Information-theoretic analysis of sparse auto-encoders using Shannon invariants. [Code: github.com/Abzinger/sae_analysis. Experimental, uses degree of redundancy and vulnerability from Gutknecht et al. 2025]
...
**NEW (2025):** Abdullah Makkeh (author of SxPID) has released a new repository for information-theoretic analysis of Sparse AutoEncoders using Shannon invariants.
