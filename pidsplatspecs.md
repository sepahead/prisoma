...
| **Agent Bridge core** | `crates/pid-bridge` | Local request/response schema, dispatcher, JSON-RPC-shaped request/response conversion, and run-log integration; network server planned | MIT (project) |
